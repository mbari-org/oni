...
public class ConceptMetadataEntity implements Serializable, IPersistentObject {
    ...
    @OneToOne(optional = false, targetEntity = ConceptEntity.class, cascade = {CascadeType.MERGE, CascadeType.REFRESH, CascadeType.DETACH, CascadeType.REFRESH}, fetch = FetchType.LAZY)
    @JoinColumn(
            name = "ConceptID_FK",
            nullable = false,
