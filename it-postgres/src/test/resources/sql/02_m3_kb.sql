...
create table Media (PrimaryMedia boolean, MediaType varchar(5), ConceptDelegateID_FK bigint not null, LAST_UPDATED_TIME timestamp(6), id bigint not null, Caption varchar(1000), Url varchar(1024), Credit varchar(255), primary key (id));
